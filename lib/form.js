...
export function $change(e, fk, message, update, root, flags, cbfn) {
    ...
    if (flags === undefined)
        flags = 0;
    var message_ = message['_'], dfbs = message_.dfbs, f = fd._, flag = 1 << (f - 1), el = e.target, msg = null, dirty = true, val;
    switch (fd.t) {
        case 1 /* BOOL */:
...
var FormPojoBuilder = /** @class */ (function () {
    ...
    FormPojoBuilder.prototype._ = function (t, a, o, name, value, display, required) {
        if (this.result)
            throw 'Already built.';
        if (this.map[name])
            throw name + " already exists.";
        var obj = this.obj, $d = this.$d, factory = this.factory, n = ++this.num, fd = { name: name, v: value, k: String(n), _: n, t: t, a: a, o: o, m: required ? 2 : 1, $n: display };
        this.map[name] = fd;
        $d[fd.k] = fd;
        $d.$fdf.push(fd.k);
        if (required) {
    ...
    FormPojoBuilder.prototype.$str = function (name, value, display, required) {
        return this._(3, 0, 0, name, value, display, required);
    };
    FormPojoBuilder.prototype.$float = function (name, value, display, required) {
        return this._(4, 0, 0, name, value, display, required);
    };
    FormPojoBuilder.prototype.$double = function (name, value, display, required) {
        return this._(5, 0, 0, name, value, display, required);
    };
    FormPojoBuilder.prototype.$int8 = function (name, value, display, required) {
        return this._(8, 0, 0, name, value, display, required);
    };
    FormPojoBuilder.prototype.$int32 = function (name, value, display, required) {
        return this._(10, 0, 0, name, value, display, required);
    };
    FormPojoBuilder.prototype.$int64 = function (name, value, display, required) {
        return this._(11, 0, 0, name, value, display, required);
    };
    FormPojoBuilder.prototype.$time = function (name, value, display, required) {
        return this._(10, 0, 1, name, value, display, required);
    };
    FormPojoBuilder.prototype.$date = function (name, value, display, required) {
        return this._(11, 0, 2, name, value, display, required);
    };
    FormPojoBuilder.prototype.$datetime = function (name, value, display, required) {

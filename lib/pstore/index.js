...
var PojoStore = /** @class */ (function () {
    function PojoStore(fetchedArray, options) {
        ...
        this.fnMergeFrom = options.merge_fn || mergeFrom;
        this.pager = pager = {
            size: size,
     ...
     * Returns the pojo.
     */
    PojoStore.prototype.$get = function (id) {
    ...
    PojoStore.prototype.$newRangeKeyForReload = function (desc) {
        ...
        key = first[this.k], kh = options.kh;
        this.startObj = first;
    ...
    PojoStore.prototype.loading = function (val) {
        var pager = this.pager, state = pager.state;
        if (!val) {
            pager.state = bit_unset(state, 8 /* LOADING */);
            return true;
        }
        if ((state & 8 /* LOADING */))
            return false;
        if (pager.msg)
            pager.msg = '';
        pager.state = bit_clear_and_set(state, 7 /* MASK_STATUS */, 8 /* LOADING */);
        return true;
    };
    return PojoStore;
}());
